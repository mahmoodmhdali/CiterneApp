            ...
            <div class="main_container">
                ...
                <footer>
                    <div class="text-center">
                        Copyright © 2016-2017 <a href="#">Citerne App</a> All rights reserved.
                    </div>
                    <div class="clearfix"></div>
                </footer>
                <!-- /footer content -->
                ...
                $('.submit-setting-btn').on('click', function (e) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data === '0' || data === '1') {
                                $('#successString').html('Installation completed. <br/><br/>  You can login as: <br/><br/> sysuser@citerneApp.com/Admin123');
                                $('.success-modal').modal();
                            } else if (data === 'Error') {
