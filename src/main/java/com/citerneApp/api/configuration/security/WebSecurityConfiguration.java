...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/adminPasses/add").hasAnyRole("SYSTEM", "OUR_SYSTEM_USER")
                .antMatchers("/adminPasses/edit").hasAnyRole("SYSTEM", "OUR_SYSTEM_USER")
                .antMatchers("/userCompanyInfo/editImages").hasAnyRole("COMPANY")
                ...
                .antMatchers("/userCompanyPasses/add").hasAnyRole("SYSTEM", "OUR_SYSTEM_USER")
                .antMatchers("/userOutletInfo/editImages").hasAnyRole("OUTLET")
