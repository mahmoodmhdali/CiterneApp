...
import com.citerneApp.api.io.LocalFileManager;
import java.io.File;
...
@ComponentScan({"com.citerneApp.api.configuration.spring"})
@PropertySource(value = "file:${catalina.home}/webapps/CiterneApp_Admin/assets/api_images/CiterneApp/config/application.properties", ignoreResourceNotFound = true)
//@PropertySource(value = "file:${catalina.home}/work/CiterneApp/config/application.properties", ignoreResourceNotFound = true)
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[]{"com.citerneApp.project.model"});
    ...
    public DataSource dataSource() {
        ...
        if (!FileUtils.getFile((context.getCatalina().getCatalinaWorkInstanceDir()) + "/config/application.properties").exists()) {
            Logger.ERROR("/!\\ application.properties is not found in Tomcat/work/CiterneApp/config /!\\. It could be either a first installation or file is deleted", "", "");
            Logger.NORMAL("/!\\ application.properties is not found in Tomcat/work/CiterneApp/config /!\\. It could be either a first installation or file is deleted", "", "");
